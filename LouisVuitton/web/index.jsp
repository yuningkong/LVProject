...
<html lang="en">
    <head>
        ...
        <!-- Morris -->
        <link href="twitterBootstrap/css/morris.css" rel="stylesheet"/>	

        <!-- Datepicker -->
        <link href="twitterBootstrap/css/datepicker.css" rel="stylesheet"/>	
        ...
        <!-- Simplify -->
        <link href="twitterBootstrap/css/simplify.css" rel="stylesheet">
    ...
    <body class="overflow-hidden">
                        ...
                        <ul class="sidebar-list">
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="image/profile1.jpg" class="img-circle" alt="user avatar">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
                                    <li class="user-avatar">
                                        <img src="image/profile1.jpg" alt="" class="img-circle">
                                    ...
                                    <ul class="dropdown-menu message pull-right">
                                        ...
                                        <li>
                                            <a class="clearfix" href="#">
                                                <img src="image/profile1.jpg" alt="User Avatar">
                                                <div class="detail">
                        ...
                        <ul class="accordion">
                            ...
                            <li class="openable bg-palette3">
                                ...
                                <ul class="submenu bg-palette4">
                                    <li><a href="form_element.html"><span class="submenu-label">Assign Tasks</span></a></li>
                                    <li><a href="form_element.html"><span class="submenu-label">Provide Access Rights</span></a></li>
                                    <li><a href="form_validation.html"><span class="submenu-label">Revoke Access Rights</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>	
                        ...
                        <div class="col-sm-6 text-right text-left-sm p-top-sm">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                    Select Events <span class="caret"></span>
                                </button>
                    ...
                    <div class="row">
                            ...
                            <div class="smart-widget widget-dark-blue">
                                ...
                                <div class="smart-widget-inner">
                                    ...
                                    <div class="smart-widget-body no-padding">
                                        <div class="padding-md">
                                            <!--hack to remedy CSS format issues-->
                                        ...
                                        <!--<div class="bg-grey">
                                            <div class="row">
                                                <div class="col-xs-4 text-center">
                                                    ...
                                                    <small class="m-bottom-sm block">xxx</small>
                                                </div>
                                                <div class="col-xs-4 text-center">
                        ...
                        <div class="col-lg-12">
                            <div class="smart-widget widget-red">
                                <div class="smart-widget-header">
                                    <b>High Priority Orders/Events</b>
                                    <span class="smart-widget-option">
                                        <span class="refresh-icon-animated">
                                            <i class="fa fa-circle-o-notch fa-spin"></i>
                                        </span>
                                ...
                                <div class="smart-widget-inner">
                                    ...
                                    <div class="smart-widget-body no-padding">
                                        <div class="padding-md">
                                            <!--hack to remedy CSS format issues-->
                                            <div id="totalSalesChart" class="morris-chart" style="height:1px; visibility:hidden"></div>
                                            <table class="table table-striped" id="highPrioityDataTable">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Product</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><button type="submit" class="btn btn-success marginTB-xs"><i class="fa fa-chevron-down"></i></button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>#1008</td>
                        ...
                        <div class="col-lg-12">
                            <div class="smart-widget widget-yellow">
                                <div class="smart-widget-header">
                                    <b>Medium Priority Orders/Events</b>
                                    <span class="smart-widget-option">
                                        <span class="refresh-icon-animated">
                                            <i class="fa fa-circle-o-notch fa-spin"></i>
                                        </span>
                                ...
                                <div class="smart-widget-inner">
                                    ...
                                    <div class="smart-widget-body no-padding">
                                        <div class="padding-md">
                                            <!--hack to remedy CSS format issues-->
                                            <div id="totalSalesChart" class="morris-chart" style="height:1px; visibility:hidden"></div>
                                            <table class="table table-striped" id="mediumPrioityDataTable">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Product</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Sep 29,2013</td>
                                                        <td><span class="label label-success">In Stock</span></td>
                                                        <td><button type="submit" class="btn btn-success marginTB-xs"><i class="fa fa-chevron-up"></i>&nbsp;<i class="fa fa-chevron-down"></i></button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>#1008</td>
                                                        <td>Leopard Rose Dress</td>
        ...
        <!-- Flot -->
        <script src='twitterBootstrap/js/jquery.flot.min.js'></script>

        <!-- Slimscroll -->
        <script src='twitterBootstrap/js/jquery.slimscroll.min.js'></script>

        <!-- Morris -->
        <script src='twitterBootstrap/js/rapheal.min.js'></script>	
        <script src='twitterBootstrap/js/morris.min.js'></script>	

        <!-- Datepicker -->
        <script src='twitterBootstrap/js/uncompressed/datepicker.js'></script>

        <!-- Sparkline -->
        <script src='twitterBootstrap/js/sparkline.min.js'></script>

        <!-- Skycons -->
        <script src='twitterBootstrap/js/uncompressed/skycons.js'></script>

        <!-- Popup Overlay -->
        <script src='twitterBootstrap/js/jquery.popupoverlay.min.js'></script>

        <!-- Easy Pie Chart -->
        <script src='twitterBootstrap/js/jquery.easypiechart.min.js'></script>

        <!-- Sortable -->
        <script src='twitterBootstrap/js/uncompressed/jquery.sortable.js'></script>

        <!-- Owl Carousel -->
        <script src='twitterBootstrap/js/owl.carousel.min.js'></script>
        ...
        <script src="twitterBootstrap/js/simplify/simplify_dashboard.js"></script>
        ...
        <script>
            ...
            $(function () {
                $('#highPrioityDataTable').dataTable();
                $('#mediumPrioityDataTable').dataTable();
            });
        </script>
    </body>
</html>
